...
- [ ] Explain the differences between `client-side routing` and `server-side routing`.
    ...
    - Client-side routing is when the actual app uses it's own memory to manage data/render the page.
    - Server-side routing is when the server manages the data/rendering of the page.
